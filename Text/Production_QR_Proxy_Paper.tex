...
\end{equation}
We do not use this procedure since input prices may not have enough variation across firms and exogeneity can be violated if they capture input quality differences as shown by \cite{Griliches1986}. However, we use this type of identification strategy in the first stage of our model without endogeneity.
